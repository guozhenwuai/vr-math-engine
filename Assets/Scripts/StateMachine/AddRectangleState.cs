...
public class AddRectangleState : IState
{
    ...
    public AddRectangleState(SceneManager sceneManager, GameObject activeTextMesh)
    {
    ...
    {
        return (uint)SceneManager.SceneStatus.ADD_RECTANGLE;
    }
    ...
    private void UpdateStretch()
    {
        ...
        MPoint c = activeEdges[2].end;
        MPoint d = activeEdges[1].end;
        ...
        if(activeFace != null && activeFace.IsValid())
        {
            ...
            d.Render(obj.localToWorldMatrix);
